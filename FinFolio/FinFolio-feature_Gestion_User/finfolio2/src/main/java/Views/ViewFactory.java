...
public class ViewFactory {
    ...
    public void showSMSWindow() {
        FXMLLoader loader =new FXMLLoader(getClass().getResource("/com/example/finfolio/User/SMS.fxml"));
        createStage(loader);
    }
    public void showModeWindow() {
        FXMLLoader loader =new FXMLLoader(getClass().getResource("/com/example/finfolio/User/modeRecuperation.fxml"));
        createStage(loader);
    }
    ...
    *Admin Views functions
    ...
    public AnchorPane getEvenementsAdminView() {
        if (evenementsAdminView==null)
            try {
                evenementsAdminView = new FXMLLoader(getClass().getResource("/com/example/finfolio/User/evenements.fxml")).load();
            }catch (Exception e)
            {e.printStackTrace();}
