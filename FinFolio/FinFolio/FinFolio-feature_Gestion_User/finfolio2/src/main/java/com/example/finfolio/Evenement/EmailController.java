...
public class EmailController {
    ...
    public static void sendEmail(String to, String subject, String body, String eventInfo) {
        ...
        try {
            // Generate QR code
            String qrCodePath = QRCodeApi.getPathEvent();
