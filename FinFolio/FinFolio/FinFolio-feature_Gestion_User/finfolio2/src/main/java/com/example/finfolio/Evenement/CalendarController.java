...
public class CalendarController implements Initializable {
    ...
    private void createCalendarActivity(List<CalendarActivity> calendarActivities, double rectangleHeight, double rectangleWidth, StackPane stackPane) {
        ...
        calendarActivityBox.setStyle("-fx-background-color:rgba(8,120,201,0.68)");
    ...
    private Map<Integer, List<CalendarActivity>> getCalendarActivitiesMonth(ZonedDateTime dateFocus) {
        ...
        for (Don donation : donations) {
            ...
            int dayOfMonth = donationDate.getDayOfMonth();

            ZonedDateTime donationDateTime = donationDate.atStartOfDay(dateFocus.getZone());
            CalendarActivity calendarActivity = new CalendarActivity(donationDateTime, donation.getEvennement().getNom());
