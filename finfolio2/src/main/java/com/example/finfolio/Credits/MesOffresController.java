...
////////////////////////////////////////
    ...
    void Update_offre(ActionEvent event) {
        ...
        if (selectedOffre == null) {
            showAlert("Veuillez sélectionner une offre à mettre à jour.", AlertType.ERROR);
            return;
        }
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            try {
                ...
                showAlert("Veuillez entrer des valeurs valides pour le montant et l'intérêt.", AlertType.ERROR);
            }
        }
    }
    ...
    void delete_offre(ActionEvent event) {
        ...
        if (selectedOffre == null) {
            showAlert("Veuillez sélectionner une offre à supprimer.", AlertType.ERROR);
            return;
        }
