...
public class DigitalCoins {
    ...
    public DigitalCoins(int id, String code, LocalDate dateAchat, double montant, double ROI, int userId) {
        this.id = id;
        this.code = code;
    ...
    public DigitalCoins(int id, String code, double recentValue, LocalDate dateAchat, String dateVente, double montant, float leverage, double stopLoss, User user, double ROI, double prixAchat, double tax) {
        this.id=id;
        this.code = code;
